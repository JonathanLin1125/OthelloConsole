...
class Othello:
    ...
    """
    def __init__(self, row:int, col:int, turn:str, mode:str, start_board: []):
        """
        Initializes all the variables that will be stored within the Othello class
        """
        self.game_board = self._create_board(start_board)
        self.row = row
        self.col = col
        self.turn = turn
        self.mode = mode
    ...
    def _create_board(self, start_board)->[[]]:
        """
    ...
    def print_winner(self):
        """
        Prints the winner based on the mode the user inputted
        """
        if self.mode == "<":
            if(self.bcount < self.wcount):
                print("WINNER: B")
            elif(self.bcount > self.wcount):
                print("WINNER: W")
            else:
                print("WINNER: NONE")
        elif self.mode == ">":
